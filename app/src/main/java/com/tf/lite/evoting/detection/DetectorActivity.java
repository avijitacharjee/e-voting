...
import com.tf.lite.evoting.detection.customview.OverlayView;
import com.tf.lite.evoting.detection.customview.OverlayView.DrawCallback;
import com.tf.lite.evoting.detection.env.BorderedText;
import com.tf.lite.evoting.detection.env.ImageUtils;
import com.tf.lite.evoting.detection.env.Logger;
...
//                    sensorOrientation, MAINTAIN_ASPECT);
    ...
    protected void setUseNNAPI(final boolean isChecked) {
        runInBackground(() -> classifier.setUseNNAPI(isChecked));
    }
    ...
    private void onFacesDetected(long currTimestamp, List<Face> faces, boolean add) {
        ...
        for (Face face : faces) {
            ...
            if (boundingBox != null && goodConfidence) {
                ...
                final List<SimilarityClassifier.Recognition> resultsAux = classifier.recognizeImage(faceBmp, add);
